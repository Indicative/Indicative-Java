...
public class IndicativeTest {
    ...
    public void testJsonSerialization() throws Exception {
        Indicative.apiKey("Test-API-Key");
        assertThat("Event is correctly serialized to JSON",
                ...
                is(equalTo("{ \"apiKey\" : \"Test-API-Key\", \"eventUniqueId\" : \"user47\", \"eventName\" : \"Registration\", \"eventTime\" : 1377647905000, \"properties\" : { \"name\" : \"value\" }}")));
    }
